...
const REVIEWS = [
  ...
  { name: 'Soror Natasha Gordon', date: '1 Year Ago', source: 'Google Reviews', brand: 'google', text: "¡Estamos muy satisfechos con Fall Cleanups Services! Han estado ayudando a mantener nuestro jardín durante dos años y continuaremos usándolos. ¡Ellos cortan el césped, mantienen los lechos de plantas y limpian el otoño y la primavera!", details: "Full Service Lawn Care" },
  ...
  { name: 'S P', date: '2 Years Ago', source: 'Google Reviews', brand: 'google', text: "Maravilloso, puntual, atención al detalle y excelente comunicación. Tenemos muchísima suerte de que Fall Cleanups Services embellezca nuestro jardín cada semana.", details: "Weekly Lawn Maintenance" },
  ...
  { name: 'Shawna C.', date: 'Aug 13, 2023', source: 'Hired on Thumbtack', brand: 'thumbtack', text: "This company did an excellent job. My lawn had been very overgrown with a lot of weeds. Fall Cleanups Services came in and assessed what needed to be done and worked quickly, thoroughly, and professionally to get the job done. Pricing was reasonable as well. I’m now working with them for regular lawn upkeep and couldn’t be happier.", details: "Full Service Lawn Care" },
  ...
  { name: 'Olawale E.', date: 'Apr 27, 2024', source: 'Hired on Thumbtack', brand: 'thumbtack', text: "Fall Cleanups Services guys did an excellent job. The price was very reasonable and they extremely efficient and effective. I would recommend them", details: "Full Service Lawn Care" },
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 border-t-[30px] border-green-600">
      ...
      <main className="pt-40 pb-24 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-500 font-semibold max-w-2xl mx-auto">See what your Rhode Island neighbors are saying about Fall Cleanups Services.</p>
        </div>
