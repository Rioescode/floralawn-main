...
export default function SchedulePage() {
  ...
  const DELAY_TEMPLATES = {
    ...
    review: (name) => `Hi ${name}, will you help us with a review in our google profile? Fall Cleanups Services would love your feedback. Post a review to our profile: https://g.page/r/CQjJ-AbEL4N2EBE/review - Thank you very much!`
  };
    ...
    try {
      ...
      const response = await fetch('/api/customers/send-message', {
        ...
        body: JSON.stringify({
          ...
          subject: delayMessage.includes('review') ? 'Help us grow! 🌿 - Fall Cleanups Services' : null,
          customerData: {
            customer_name: customer.name,
            customer_email: customer.email,
            customer_phone: customer.phone,
