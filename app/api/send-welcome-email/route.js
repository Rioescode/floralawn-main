  ...
  try {
    ...
    const emailHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #22C55E;">Welcome to Fall Cleanups Services!</h2>
        <p>Hi ${userName},</p>
        <p>Thank you for creating an account with Fall Cleanups Services!</p>
        ...
        <div style="background-color: #f0f9ff; padding: 15px; border-radius: 8px; margin: 20px 0;">
          ...
          <a href="https://fallcleanups.com/customer/dashboard" 
        ...
        📧 Email: esckoofficial@gmail.com</p>
    ...
    await sendEmail({
      to: email,
      subject: 'Welcome to Fall Cleanups Services!',
      text: `Welcome to Fall Cleanups Services! Thank you for creating an account. Visit https://fallcleanups.com/customer/dashboard to manage your services.`,
      html: emailHtml,
