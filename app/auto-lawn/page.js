          ...
          {!selectedPlace && !isScanning && (
            ...
            >
               ...
               <div className="flex flex-wrap justify-center gap-4 max-w-5xl mx-auto">
                 {/* Nextdoor */}
                 <div className="flex items-center gap-3 bg-white px-5 py-4 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                    <img src="/nextdoor-badge.png" className="w-10 h-10 object-contain rounded-full shadow-sm" alt="Nextdoor" onError={(e) => e.target.style.display = 'none'} />
                    <div className="text-left">
                       <p className="text-xs font-black uppercase tracking-widest text-[#00b246]">2025 Fave Winner</p>
                       <p className="text-[10px] font-bold text-slate-400 uppercase">Neighborhood Favorite</p>
                    </div>
                 </div>
                 {/* BusinessRate */}
                 <div className="flex items-center gap-3 bg-white px-5 py-4 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                    <img src="/businessrate-badge.png" className="w-10 h-10 object-contain rounded-full shadow-sm" alt="BusinessRate" onError={(e) => e.target.style.display = 'none'} />
                    <div className="text-left">
                       <p className="text-xs font-black uppercase tracking-widest text-slate-900">Best of 2025</p>
                       <p className="text-[10px] font-bold text-slate-400 uppercase">BusinessRate</p>
                    </div>
                 </div>
                 {/* Google */}
                 <div className="flex items-center gap-4 bg-white px-5 py-4 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                    <div className="text-right">
                       <p className="text-[10px] font-black uppercase tracking-widest text-[#4285F4] flex items-center gap-1 justify-end"><svg className="w-3 h-3" viewBox="0 0 24 24"><path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg> 4.9 Rating</p>
                       <p className="text-[10px] font-bold text-slate-400 uppercase mt-1">31 Verified Reviews</p>
                    </div>
                 </div>
                 {/* Thumbtack */}
                 <div className="flex items-center gap-4 bg-white px-5 py-4 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                    <div className="text-left font-bold border-l-2 border-[#009FD9] pl-3">
                       <p className="text-[10px] font-black uppercase tracking-widest text-[#009FD9]">4.8 Thumbtack Pro</p>
                       <p className="text-[10px] font-bold text-slate-400 uppercase mt-1">71 Verified Reviews</p>
                    </div>
                 </div>
               </div>
            </motion.div>
